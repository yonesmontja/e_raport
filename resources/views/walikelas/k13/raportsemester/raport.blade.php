            ...
            <table>
                <tr>
                    <div style="text-align: center; padding-bottom: 10px;">
                        <img src="assets/images/logo/logo.png" alt="Logo" width="20%">
                    </div>
                </tr>
                <tr>
    ...
    <div class="invoice-box">
        ...
        <div class="content">
            <table cellspacing="0">
                ...
                <!-- Catatan Wali Kelas -->
                <tr>
                    <td colspan="4" style="height: 25px; padding-top: 5px"><strong>F. CATATAN WALI KELAS</strong>
                    </td>
                </tr>
                <tr class="sikap">
                ...
                <tr>
                    <td colspan="4" style="height: 25px; padding-top: 5px"><strong>G. TANGGAPAN ORANG
                            TUA/WALI</strong></td>
                </tr>
                <tr class="sikap">
        ...
        <div class="footer">
            <i>{{ $anggota_kelas->kelas->nama_kelas }} | {{ $anggota_kelas->siswa->nama_lengkap }} |
                {{ $anggota_kelas->siswa->nis }}</i> <b style="float: right;"><i>Halaman 4</i></b>
        </div>
    </div>
</body>
